<%@ Page Language="C#" AutoEventWireup="true" ClientIDMode="Static" MasterPageFile="DataImportMaster.Master" CodeBehind="TemplateTasks.aspx.cs" Inherits="ManageUPPRM.dashjs.admin.dataImporters.TemplateTasks" %>


<asp:Content ID="Content2" ContentPlaceHolderID="instructions" runat="server">

    <h3>Instructions</h3>
    <h5>1. <a onclick="window.open('exampleFiles/TemplateTasks.xls');">Download the example file and check the file format.</a></h5>
    ...
    <br />
    <h5>NOTE: Existing tasks and action items are going to be <b>UPDATED</b></h5>

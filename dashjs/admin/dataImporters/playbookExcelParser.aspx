<%@ Page Language="C#" AutoEventWireup="true" ClientIDMode="Static" MasterPageFile="DataImportMaster.Master"  CodeBehind="playbookExcelParser.aspx.cs" Inherits="ManageUPPRM.dashjs.playbookExcelParser" %>

<asp:Content ID="Content2" ContentPlaceHolderID="instructions" runat="server">
<h3>Instructions</h3>
    <h5>1. <a onclick="window.open('exampleFiles/playbook.xls');">Download the example file and check the file format.</a></h5>

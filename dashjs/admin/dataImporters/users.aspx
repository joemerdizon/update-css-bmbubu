<%@ Page Language="C#" AutoEventWireup="true" ClientIDMode="Static" MasterPageFile="DataImportMaster.Master"  CodeBehind="users.aspx.cs" Inherits="ManageUPPRM.dashjs.admin.dataImporters.users" %>

<asp:Content ID="Content2" ContentPlaceHolderID="instructions" runat="server">
<h3>Instructions</h3>
    <h5>1. <a onclick="window.open('exampleFiles/users.xls');">Download the example file and check the file format.</a></h5>

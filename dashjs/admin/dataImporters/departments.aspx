<%@ Page Language="C#" AutoEventWireup="true" ClientIDMode="Static" MasterPageFile="DataImportMaster.Master"  CodeBehind="departments.aspx.cs" Inherits="ManageUPPRM.dashjs.admin.dataImporters.departments" %>

<asp:Content ID="Content2" ContentPlaceHolderID="instructions" runat="server">

    <h3>Instructions</h3>

    <h5>1. <a onclick="window.open('exampleFiles/departments.xls');">Download the example file and check the file format.</a></h5>

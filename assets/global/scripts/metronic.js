...
var Metronic = function () {
    ...
    var handlePortletTools = function () {
        ...
        $('body').on('click', '.portlet > .portlet-title > .tools > a.remove', function (e) {
            return; //agregado por matïas para evitar el funcionamiento por default de metronic.
            e.preventDefault();
    ...
    var handleTooltips = function () {
        ...
        $('.portlet > .portlet-title > .tools > .edit').tooltip({
            container: 'body',
            title: 'Edit'
        });
        $('.portlet > .portlet-title > .tools > .heart').tooltip({
            container: 'body',
            title: 'Favorite'
        });
    };
